package com.gameclub.community;
...
public class AutoGenerateTest {
    ...
    public void autoGenerate() {
        ...
        // 填写代码生成的目录(需要修改)
        String projectPath = "D:\\BaiduNetdiskDownload\\GameCommunity";
        // 拼接出代码最终输出的目录
        ...
        // 配置数据库 url 地址
        dsc.setUrl("jdbc:mysql://114.55.135.31/communitydb");
